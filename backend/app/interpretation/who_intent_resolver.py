...
class WhoIntentResolver:
    ...
    def resolve(
        ...
        result = self._resolve_core(text)
    ...
    def _origin_query(
        ...
        if self._origin_query_core(text):
            return True
    ...
    def _cause_query(
        ...
        if self._cause_query_core(text):
            return True
    ...
    def _non_covid_vaccine_context(
        ...
        return self._non_covid_vaccine_context_core(text)
    ...
    def _non_covid_vaccine_context_core(
        self,
        text: str,
    ):
        return any(
